...
class TimetableController {
	...
	public function __construct() {  
        $this->model = new TimetableModelAdmin();
...
Database::disconnect();
	...
	public function deleteTimetable($id) {
		if (isset($_GET['id'])) {
			...
			$geridon2=$_GET['gelencategory_id'];
		...
		header('Location: list.php?id='.$geridon.'&category_id='.$geridon2); //BUNU YAP
