...
if ($_SESSION['user']['role'] == 2) {
    ...
    if ($_SESSION['user']['role'] == 2 &&  $gelenmarkaid !== null && $gelencategory_id !== null) {
...
<div class="tiva-timetable-list table-responsive col-md-12" style=" margin-top:50px;">
    ...
    <?php foreach ($timetables as $timetable) { 
      ...
      <div class="card">
        ...
        <h4 style="position: relative; margin: 0 0 24px; padding-bottom: 10px; text-align: center; font-size: 16px; font-weight: 700;"><a href="https://ajaxcalender.clicksuslabs.com/index.php?marka_id=<?php echo $gelenmarkaid;?>&category_id=<?php echo $timetable['id'];?>" target="_blank"> <i class="fa fa-calendar"></i> Takvime Git </a> </h4>
...
<td>
    <?php echo translateDay($timetable['day']); ?>
</td>
            <td >
